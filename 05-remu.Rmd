...
Cuando vamos a correr este método usalmente utilizamos un $k = 5$ 0 $k = 10$, esto hace que sea muy sencillo de correr en cualquier método de aprendizaje estadístico, dado que la validación cruzada solo va a correr 5 o 10 veces.
...
Donde $Err_{i} = I(y_{i} \neq \hat_{y_{i}})$. El error para *k*-fold CV y el error para el set de validación son definidos análogamente.
