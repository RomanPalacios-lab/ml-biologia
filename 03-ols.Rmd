...
Esto quiere decir que cuando no hay una relación entre la repuesta y el predictor, el estadístico F tomaría valores cerca a 1. Mientras que si $H_{\alpha}$ fuera verdadera, entocnes el *estadístico F* tomaría valores mayores a 1, es decir, $E[(TSS - RSS)/p] > \alpha^{2}$.
...
Si queremos probar una modelo que contenga todas las variables *excepción* de las *q*. Supongamos que la suma de cuadrados de los residuospara este modelo es $RSS_{0}$, entonces la formar de calcular el *estadístico F* sería.
